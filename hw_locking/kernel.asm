...
8010216e:	8b 15 64 a5 10 80    	mov    0x8010a564,%edx
80102174:	83 c4 10             	add    $0x10,%esp
  b->qnext = 0;
80102177:	c7 43 58 00 00 00 00 	movl   $0x0,0x58(%ebx)
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
8010217e:	85 d2                	test   %edx,%edx
80102180:	75 08                	jne    8010218a <iderw+0x6a>
80102182:	eb 6c                	jmp    801021f0 <iderw+0xd0>
...
801021cb:	fa                   	cli    
  ...
  cli();
  release(&idelock);
801021cc:	c7 45 08 80 a5 10 80 	movl   $0x8010a580,0x8(%ebp)
}
801021d3:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801021d6:	c9                   	leave  
  release(&idelock);
801021d7:	e9 24 22 00 00       	jmp    80104400 <release>
