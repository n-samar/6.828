...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 99 77 10 80 	movl   $0x80107799,(%esp)
...
80102e83:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e86:	e8 45 3a 00 00       	call   801068d0 <switchkvm>
  seginit();
...
80102ee4:	e8 27 2c 00 00       	call   80105b10 <uartinit>
  pinit();         // process table
...
80103841:	e8 ba 31 00 00       	call   80106a00 <inituvm>
...
8010392c:	e8 bf 2f 00 00       	call   801068f0 <switchuvm>
  return 0;
...
8010394a:	e8 f1 31 00 00       	call   80106b40 <allocuvm>
...
80103af0:	e8 fb 2d 00 00       	call   801068f0 <switchuvm>
...
80103b02:	e8 84 0b 00 00       	call   8010468b <swtch>
      switchkvm();
80103b07:	e8 c4 2d 00 00       	call   801068d0 <switchkvm>
      c->proc = 0;
...
80103d0d:	68 9d 75 10 80       	push   $0x8010759d
80103d12:	e8 79 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d17:	83 ec 0c             	sub    $0xc,%esp
80103d1a:	68 90 75 10 80       	push   $0x80107590
...
80103e29:	68 af 75 10 80       	push   $0x801075af
80103e2e:	e8 5d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e33:	83 ec 0c             	sub    $0xc,%esp
80103e36:	68 a9 75 10 80       	push   $0x801075a9
...
80103ed2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ed9:	e8 b2 2d 00 00       	call   80106c90 <freevm>
        release(&ptable.lock);
...
8010402b:	68 99 77 10 80       	push   $0x80107799
...
8010404e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104051:	ba c0 75 10 80       	mov    $0x801075c0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104056:	77 11                	ja     80104069 <procdump+0x59>
80104058:	8b 14 85 20 76 10 80 	mov    -0x7fef89e0(,%eax,4),%edx
      state = "???";
8010405f:	b8 c0 75 10 80       	mov    $0x801075c0,%eax
...
80104071:	68 c4 75 10 80       	push   $0x801075c4
...
801040ad:	68 01 70 10 80       	push   $0x80107001
...
801040da:	68 38 76 10 80       	push   $0x80107638
...
801042f5:	68 43 76 10 80       	push   $0x80107643
801042fa:	e8 91 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
801042ff:	83 ec 0c             	sub    $0xc,%esp
80104302:	68 5a 76 10 80       	push   $0x8010765a
...
801043e7:	68 61 76 10 80       	push   $0x80107661
...
8010443c:	68 69 76 10 80       	push   $0x80107669
...
8010485c:	8b 14 85 a0 76 10 80 	mov    -0x7fef8960(,%eax,4),%edx
...
80104880:	68 71 76 10 80       	push   $0x80107671
...
801049d4:	68 18 77 10 80       	push   $0x80107718
...
801049ec:	68 17 77 10 80       	push   $0x80107717
...
80104a05:	68 0b 77 10 80       	push   $0x8010770b
...
80104a1a:	68 1a 77 10 80       	push   $0x8010771a
80104a1f:	e8 6c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a24:	83 ec 0c             	sub    $0xc,%esp
80104a27:	68 fc 76 10 80       	push   $0x801076fc
...
80104e19:	58                   	pop    %eax
80104e1a:	5a                   	pop    %edx
80104e1b:	68 18 77 10 80       	push   $0x80107718
...
80104e34:	68 17 77 10 80       	push   $0x80107717
...
801054fc:	e8 4f f2 ff ff       	call   80104750 <argint>
...
80105557:	78 1f                	js     80105578 <sys_sbrk+0x38>
    return -1;
  addr = myproc()->sz;  
80105559:	e8 82 e2 ff ff       	call   801037e0 <myproc>
8010555e:	8b 18                	mov    (%eax),%ebx
  myproc()->sz+=n;
80105560:	e8 7b e2 ff ff       	call   801037e0 <myproc>
80105565:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105568:	01 10                	add    %edx,(%eax)
  /*
  if(growproc(n) < 0)
    return -1;
  */
...
8010556a:	89 d8                	mov    %ebx,%eax
8010556c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010556f:	c9                   	leave  
80105570:	c3                   	ret    
80105571:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    return -1;
80105578:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
8010557d:	eb eb                	jmp    8010556a <sys_sbrk+0x2a>
8010557f:	90                   	nop
...
801056ce:	00 00 ef 
  initlock(&tickslock, "time");
801056d1:	68 5d 77 10 80       	push   $0x8010775d
...
80105742:	0f 84 f8 00 00 00    	je     80105840 <trap+0x110>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105750:	ff 24 85 38 78 10 80 	jmp    *-0x7fef87c8(,%eax,4)
...
80105767:	0f 84 e9 02 00 00    	je     80105a56 <trap+0x326>
8010576d:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105771:	0f 84 df 02 00 00    	je     80105a56 <trap+0x326>
...
80105777:	83 7f 30 0e          	cmpl   $0xe,0x30(%edi)
8010577b:	0f 84 d7 01 00 00    	je     80105958 <trap+0x228>
...
80105784:	8b 57 38             	mov    0x38(%edi),%edx
80105787:	89 4d d8             	mov    %ecx,-0x28(%ebp)
8010578a:	89 55 dc             	mov    %edx,-0x24(%ebp)
8010578d:	e8 2e e0 ff ff       	call   801037c0 <cpuid>
80105792:	8b 77 34             	mov    0x34(%edi),%esi
80105795:	8b 5f 30             	mov    0x30(%edi),%ebx
80105798:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	    "eip 0x%x addr 0x%x--kill proc\n",
	    myproc()->pid, myproc()->name, tf->trapno,
8010579b:	e8 40 e0 ff ff       	call   801037e0 <myproc>
801057a0:	89 45 e0             	mov    %eax,-0x20(%ebp)
801057a3:	e8 38 e0 ff ff       	call   801037e0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801057a8:	8b 4d d8             	mov    -0x28(%ebp),%ecx
801057ab:	8b 55 dc             	mov    -0x24(%ebp),%edx
801057ae:	51                   	push   %ecx
801057af:	52                   	push   %edx
	    myproc()->pid, myproc()->name, tf->trapno,
801057b0:	8b 55 e0             	mov    -0x20(%ebp),%edx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801057b3:	ff 75 e4             	pushl  -0x1c(%ebp)
801057b6:	56                   	push   %esi
801057b7:	53                   	push   %ebx
	    myproc()->pid, myproc()->name, tf->trapno,
801057b8:	83 c2 6c             	add    $0x6c,%edx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801057bb:	52                   	push   %edx
801057bc:	ff 70 10             	pushl  0x10(%eax)
801057bf:	68 f4 77 10 80       	push   $0x801077f4
801057c4:	e8 97 ae ff ff       	call   80100660 <cprintf>
	    tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801057c9:	83 c4 20             	add    $0x20,%esp
801057cc:	e8 0f e0 ff ff       	call   801037e0 <myproc>
801057d1:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
...
80105805:	74 0b                	je     80105812 <trap+0xe2>
80105807:	e8 d4 df ff ff       	call   801037e0 <myproc>
8010580c:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105810:	74 66                	je     80105878 <trap+0x148>
...
80105819:	74 19                	je     80105834 <trap+0x104>
8010581b:	e8 c0 df ff ff       	call   801037e0 <myproc>
80105820:	8b 40 24             	mov    0x24(%eax),%eax
80105823:	85 c0                	test   %eax,%eax
80105825:	74 0d                	je     80105834 <trap+0x104>
80105827:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
8010582b:	83 e0 03             	and    $0x3,%eax
8010582e:	66 83 f8 03          	cmp    $0x3,%ax
80105832:	74 35                	je     80105869 <trap+0x139>
    exit();
}
...
80105845:	8b 58 24             	mov    0x24(%eax),%ebx
80105848:	85 db                	test   %ebx,%ebx
8010584a:	0f 85 e8 00 00 00    	jne    80105938 <trap+0x208>
    myproc()->tf = tf;
80105850:	e8 8b df ff ff       	call   801037e0 <myproc>
80105855:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105858:	e8 e3 ef ff ff       	call   80104840 <syscall>
    if(myproc()->killed)
8010585d:	e8 7e df ff ff       	call   801037e0 <myproc>
80105862:	8b 48 24             	mov    0x24(%eax),%ecx
80105865:	85 c9                	test   %ecx,%ecx
80105867:	74 cb                	je     80105834 <trap+0x104>
}
...
8010586f:	5d                   	pop    %ebp
      exit();
80105870:	e9 8b e3 ff ff       	jmp    80103c00 <exit>
80105875:	8d 76 00             	lea    0x0(%esi),%esi
  if(myproc() && myproc()->state == RUNNING &&
80105878:	83 7f 30 20          	cmpl   $0x20,0x30(%edi)
8010587c:	75 94                	jne    80105812 <trap+0xe2>
    yield();
8010587e:	e8 ad e4 ff ff       	call   80103d30 <yield>
80105883:	eb 8d                	jmp    80105812 <trap+0xe2>
80105885:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105888:	e8 33 df ff ff       	call   801037c0 <cpuid>
8010588d:	85 c0                	test   %eax,%eax
8010588f:	0f 84 5b 01 00 00    	je     801059f0 <trap+0x2c0>
    lapiceoi();
80105895:	e8 b6 ce ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010589a:	e8 41 df ff ff       	call   801037e0 <myproc>
8010589f:	85 c0                	test   %eax,%eax
801058a1:	0f 85 3a ff ff ff    	jne    801057e1 <trap+0xb1>
801058a7:	e9 52 ff ff ff       	jmp    801057fe <trap+0xce>
801058ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801058b0:	e8 5b cd ff ff       	call   80102610 <kbdintr>
    lapiceoi();
801058b5:	e8 96 ce ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058ba:	e8 21 df ff ff       	call   801037e0 <myproc>
801058bf:	85 c0                	test   %eax,%eax
801058c1:	0f 85 1a ff ff ff    	jne    801057e1 <trap+0xb1>
801058c7:	e9 32 ff ff ff       	jmp    801057fe <trap+0xce>
801058cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
801058d0:	e8 2b 03 00 00       	call   80105c00 <uartintr>
    lapiceoi();
801058d5:	e8 76 ce ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058da:	e8 01 df ff ff       	call   801037e0 <myproc>
801058df:	85 c0                	test   %eax,%eax
801058e1:	0f 85 fa fe ff ff    	jne    801057e1 <trap+0xb1>
801058e7:	e9 12 ff ff ff       	jmp    801057fe <trap+0xce>
...
801058f7:	e8 c4 de ff ff       	call   801037c0 <cpuid>
801058fc:	56                   	push   %esi
801058fd:	53                   	push   %ebx
801058fe:	50                   	push   %eax
801058ff:	68 9c 77 10 80       	push   $0x8010779c
80105904:	e8 57 ad ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105909:	e8 42 ce ff ff       	call   80102750 <lapiceoi>
    break;
8010590e:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105911:	e8 ca de ff ff       	call   801037e0 <myproc>
80105916:	85 c0                	test   %eax,%eax
80105918:	0f 85 c3 fe ff ff    	jne    801057e1 <trap+0xb1>
8010591e:	e9 db fe ff ff       	jmp    801057fe <trap+0xce>
80105923:	90                   	nop
80105924:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105928:	e8 53 c7 ff ff       	call   80102080 <ideintr>
8010592d:	e9 63 ff ff ff       	jmp    80105895 <trap+0x165>
80105932:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105938:	e8 c3 e2 ff ff       	call   80103c00 <exit>
8010593d:	e9 0e ff ff ff       	jmp    80105850 <trap+0x120>
80105942:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105948:	e8 b3 e2 ff ff       	call   80103c00 <exit>
8010594d:	e9 ac fe ff ff       	jmp    801057fe <trap+0xce>
80105952:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80105958:	0f 20 d3             	mov    %cr2,%ebx
      char *mem = kalloc();
8010595b:	e8 60 cb ff ff       	call   801024c0 <kalloc>
      char *fault_pg = (char*)PGROUNDDOWN((uint)rcr2());
80105960:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
      if (mem == 0) {
80105966:	85 c0                	test   %eax,%eax
      char *mem = kalloc();
80105968:	89 c6                	mov    %eax,%esi
      if (mem == 0) {
8010596a:	0f 84 b4 00 00 00    	je     80105a24 <trap+0x2f4>
      memset(mem, 0, PGSIZE);
80105970:	83 ec 04             	sub    $0x4,%esp
80105973:	68 00 10 00 00       	push   $0x1000
80105978:	6a 00                	push   $0x0
8010597a:	56                   	push   %esi
8010597b:	e8 d0 ea ff ff       	call   80104450 <memset>
      if(mappages(myproc()->pgdir, (char*)fault_pg, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80105980:	e8 5b de ff ff       	call   801037e0 <myproc>
80105985:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
8010598b:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80105992:	52                   	push   %edx
80105993:	68 00 10 00 00       	push   $0x1000
80105998:	53                   	push   %ebx
80105999:	ff 70 04             	pushl  0x4(%eax)
8010599c:	e8 9f 0e 00 00       	call   80106840 <mappages>
801059a1:	83 c4 20             	add    $0x20,%esp
801059a4:	85 c0                	test   %eax,%eax
801059a6:	0f 89 2c fe ff ff    	jns    801057d8 <trap+0xa8>
	cprintf("allocuvm out of memory (2)\n");
801059ac:	83 ec 0c             	sub    $0xc,%esp
801059af:	68 7f 77 10 80       	push   $0x8010777f
801059b4:	e8 a7 ac ff ff       	call   80100660 <cprintf>
	deallocuvm(myproc()->pgdir, (uint)fault_pg, (uint)fault_pg+PGSIZE);	
801059b9:	e8 22 de ff ff       	call   801037e0 <myproc>
801059be:	8d 93 00 10 00 00    	lea    0x1000(%ebx),%edx
801059c4:	83 c4 0c             	add    $0xc,%esp
801059c7:	52                   	push   %edx
801059c8:	53                   	push   %ebx
801059c9:	ff 70 04             	pushl  0x4(%eax)
801059cc:	e8 8f 12 00 00       	call   80106c60 <deallocuvm>
	kfree(mem);
801059d1:	89 34 24             	mov    %esi,(%esp)
801059d4:	e8 37 c9 ff ff       	call   80102310 <kfree>
	exit();
801059d9:	e8 22 e2 ff ff       	call   80103c00 <exit>
801059de:	83 c4 10             	add    $0x10,%esp
801059e1:	e9 f2 fd ff ff       	jmp    801057d8 <trap+0xa8>
...
80105a1f:	e9 71 fe ff ff       	jmp    80105895 <trap+0x165>
	cprintf("allocuvm out of memory\n");
80105a24:	83 ec 0c             	sub    $0xc,%esp
80105a27:	68 67 77 10 80       	push   $0x80107767
80105a2c:	e8 2f ac ff ff       	call   80100660 <cprintf>
	deallocuvm(myproc()->pgdir, (uint)fault_pg, (uint)fault_pg+PGSIZE);
80105a31:	e8 aa dd ff ff       	call   801037e0 <myproc>
80105a36:	8d 93 00 10 00 00    	lea    0x1000(%ebx),%edx
80105a3c:	83 c4 0c             	add    $0xc,%esp
80105a3f:	52                   	push   %edx
80105a40:	53                   	push   %ebx
80105a41:	ff 70 04             	pushl  0x4(%eax)
80105a44:	e8 17 12 00 00       	call   80106c60 <deallocuvm>
	exit();
80105a49:	e8 b2 e1 ff ff       	call   80103c00 <exit>
80105a4e:	83 c4 10             	add    $0x10,%esp
80105a51:	e9 1a ff ff ff       	jmp    80105970 <trap+0x240>
80105a56:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105a59:	8b 5f 38             	mov    0x38(%edi),%ebx
80105a5c:	e8 5f dd ff ff       	call   801037c0 <cpuid>
80105a61:	83 ec 0c             	sub    $0xc,%esp
80105a64:	56                   	push   %esi
80105a65:	53                   	push   %ebx
80105a66:	50                   	push   %eax
80105a67:	ff 77 30             	pushl  0x30(%edi)
80105a6a:	68 c0 77 10 80       	push   $0x801077c0
80105a6f:	e8 ec ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105a74:	83 c4 14             	add    $0x14,%esp
80105a77:	68 62 77 10 80       	push   $0x80107762
80105a7c:	e8 0f a9 ff ff       	call   80100390 <panic>
...
80105ae5:	e8 86 cc ff ff       	call   80102770 <microdelay>
...
80105b7c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105b7f:	bb b8 78 10 80       	mov    $0x801078b8,%ebx
  ioapicenable(IRQ_COM1, 0);
80105b84:	6a 00                	push   $0x0
80105b86:	6a 04                	push   $0x4
80105b88:	e8 43 c7 ff ff       	call   801022d0 <ioapicenable>
...
80105c17:	6a 00                	push   $0x0
  jmp alltraps
80105c19:	e9 3c fa ff ff       	jmp    8010565a <alltraps>
...
80105c20:	6a 01                	push   $0x1
  jmp alltraps
80105c22:	e9 33 fa ff ff       	jmp    8010565a <alltraps>
...
80105c29:	6a 02                	push   $0x2
  jmp alltraps
80105c2b:	e9 2a fa ff ff       	jmp    8010565a <alltraps>
...
80105c32:	6a 03                	push   $0x3
  jmp alltraps
80105c34:	e9 21 fa ff ff       	jmp    8010565a <alltraps>
...
80105c3b:	6a 04                	push   $0x4
  jmp alltraps
80105c3d:	e9 18 fa ff ff       	jmp    8010565a <alltraps>
...
80105c44:	6a 05                	push   $0x5
  jmp alltraps
80105c46:	e9 0f fa ff ff       	jmp    8010565a <alltraps>
...
80105c56:	6a 07                	push   $0x7
  jmp alltraps
80105c58:	e9 fd f9 ff ff       	jmp    8010565a <alltraps>
...
80105c5d:	6a 08                	push   $0x8
  jmp alltraps
80105c5f:	e9 f6 f9 ff ff       	jmp    8010565a <alltraps>
...
80105c66:	6a 09                	push   $0x9
  jmp alltraps
80105c68:	e9 ed f9 ff ff       	jmp    8010565a <alltraps>
...
80105c74:	6a 0b                	push   $0xb
  jmp alltraps
80105c76:	e9 df f9 ff ff       	jmp    8010565a <alltraps>
...
80105c89:	6a 0e                	push   $0xe
  jmp alltraps
80105c8b:	e9 ca f9 ff ff       	jmp    8010565a <alltraps>
...
80105c92:	6a 0f                	push   $0xf
  jmp alltraps
80105c94:	e9 c1 f9 ff ff       	jmp    8010565a <alltraps>
...
80105c9b:	6a 10                	push   $0x10
  jmp alltraps
80105c9d:	e9 b8 f9 ff ff       	jmp    8010565a <alltraps>
...
80105ca2:	6a 11                	push   $0x11
  jmp alltraps
80105ca4:	e9 b1 f9 ff ff       	jmp    8010565a <alltraps>
...
80105cab:	6a 12                	push   $0x12
  jmp alltraps
80105cad:	e9 a8 f9 ff ff       	jmp    8010565a <alltraps>
...
80105cb4:	6a 13                	push   $0x13
  jmp alltraps
80105cb6:	e9 9f f9 ff ff       	jmp    8010565a <alltraps>
...
80105cbd:	6a 14                	push   $0x14
  jmp alltraps
80105cbf:	e9 96 f9 ff ff       	jmp    8010565a <alltraps>
...
80105cc6:	6a 15                	push   $0x15
  jmp alltraps
80105cc8:	e9 8d f9 ff ff       	jmp    8010565a <alltraps>
...
80105ccf:	6a 16                	push   $0x16
  jmp alltraps
80105cd1:	e9 84 f9 ff ff       	jmp    8010565a <alltraps>
...
80105cd8:	6a 17                	push   $0x17
  jmp alltraps
80105cda:	e9 7b f9 ff ff       	jmp    8010565a <alltraps>
...
80105ce1:	6a 18                	push   $0x18
  jmp alltraps
80105ce3:	e9 72 f9 ff ff       	jmp    8010565a <alltraps>
...
80105cea:	6a 19                	push   $0x19
  jmp alltraps
80105cec:	e9 69 f9 ff ff       	jmp    8010565a <alltraps>
...
80105cf3:	6a 1a                	push   $0x1a
  jmp alltraps
80105cf5:	e9 60 f9 ff ff       	jmp    8010565a <alltraps>
...
80105cfc:	6a 1b                	push   $0x1b
  jmp alltraps
80105cfe:	e9 57 f9 ff ff       	jmp    8010565a <alltraps>
...
80105d05:	6a 1c                	push   $0x1c
  jmp alltraps
80105d07:	e9 4e f9 ff ff       	jmp    8010565a <alltraps>
...
80105d0e:	6a 1d                	push   $0x1d
  jmp alltraps
80105d10:	e9 45 f9 ff ff       	jmp    8010565a <alltraps>
...
80105d17:	6a 1e                	push   $0x1e
  jmp alltraps
80105d19:	e9 3c f9 ff ff       	jmp    8010565a <alltraps>
...
80105d20:	6a 1f                	push   $0x1f
  jmp alltraps
80105d22:	e9 33 f9 ff ff       	jmp    8010565a <alltraps>
...
80105d29:	6a 20                	push   $0x20
  jmp alltraps
80105d2b:	e9 2a f9 ff ff       	jmp    8010565a <alltraps>
...
80105d32:	6a 21                	push   $0x21
  jmp alltraps
80105d34:	e9 21 f9 ff ff       	jmp    8010565a <alltraps>
...
80105d3b:	6a 22                	push   $0x22
  jmp alltraps
80105d3d:	e9 18 f9 ff ff       	jmp    8010565a <alltraps>
...
80105d44:	6a 23                	push   $0x23
  jmp alltraps
80105d46:	e9 0f f9 ff ff       	jmp    8010565a <alltraps>
...
80105d4d:	6a 24                	push   $0x24
  jmp alltraps
80105d4f:	e9 06 f9 ff ff       	jmp    8010565a <alltraps>
...
80105d56:	6a 25                	push   $0x25
  jmp alltraps
80105d58:	e9 fd f8 ff ff       	jmp    8010565a <alltraps>
...
80105d5f:	6a 26                	push   $0x26
  jmp alltraps
80105d61:	e9 f4 f8 ff ff       	jmp    8010565a <alltraps>
...
80105d68:	6a 27                	push   $0x27
  jmp alltraps
80105d6a:	e9 eb f8 ff ff       	jmp    8010565a <alltraps>
...
80105d71:	6a 28                	push   $0x28
  jmp alltraps
80105d73:	e9 e2 f8 ff ff       	jmp    8010565a <alltraps>
...
80105d7a:	6a 29                	push   $0x29
  jmp alltraps
80105d7c:	e9 d9 f8 ff ff       	jmp    8010565a <alltraps>
...
80105d83:	6a 2a                	push   $0x2a
  jmp alltraps
80105d85:	e9 d0 f8 ff ff       	jmp    8010565a <alltraps>
...
80105d8c:	6a 2b                	push   $0x2b
  jmp alltraps
80105d8e:	e9 c7 f8 ff ff       	jmp    8010565a <alltraps>
...
80105d95:	6a 2c                	push   $0x2c
  jmp alltraps
80105d97:	e9 be f8 ff ff       	jmp    8010565a <alltraps>
...
80105d9e:	6a 2d                	push   $0x2d
  jmp alltraps
80105da0:	e9 b5 f8 ff ff       	jmp    8010565a <alltraps>
...
80105da7:	6a 2e                	push   $0x2e
  jmp alltraps
80105da9:	e9 ac f8 ff ff       	jmp    8010565a <alltraps>
...
80105db0:	6a 2f                	push   $0x2f
  jmp alltraps
80105db2:	e9 a3 f8 ff ff       	jmp    8010565a <alltraps>
...
80105db9:	6a 30                	push   $0x30
  jmp alltraps
80105dbb:	e9 9a f8 ff ff       	jmp    8010565a <alltraps>
...
80105dc2:	6a 31                	push   $0x31
  jmp alltraps
80105dc4:	e9 91 f8 ff ff       	jmp    8010565a <alltraps>
...
80105dcb:	6a 32                	push   $0x32
  jmp alltraps
80105dcd:	e9 88 f8 ff ff       	jmp    8010565a <alltraps>
...
80105dd4:	6a 33                	push   $0x33
  jmp alltraps
80105dd6:	e9 7f f8 ff ff       	jmp    8010565a <alltraps>
...
80105ddd:	6a 34                	push   $0x34
  jmp alltraps
80105ddf:	e9 76 f8 ff ff       	jmp    8010565a <alltraps>
...
80105de6:	6a 35                	push   $0x35
  jmp alltraps
80105de8:	e9 6d f8 ff ff       	jmp    8010565a <alltraps>
...
80105def:	6a 36                	push   $0x36
  jmp alltraps
80105df1:	e9 64 f8 ff ff       	jmp    8010565a <alltraps>
...
80105df8:	6a 37                	push   $0x37
  jmp alltraps
80105dfa:	e9 5b f8 ff ff       	jmp    8010565a <alltraps>
...
80105e01:	6a 38                	push   $0x38
  jmp alltraps
80105e03:	e9 52 f8 ff ff       	jmp    8010565a <alltraps>
...
80105e0a:	6a 39                	push   $0x39
  jmp alltraps
80105e0c:	e9 49 f8 ff ff       	jmp    8010565a <alltraps>
...
80105e13:	6a 3a                	push   $0x3a
  jmp alltraps
80105e15:	e9 40 f8 ff ff       	jmp    8010565a <alltraps>
...
80105e1c:	6a 3b                	push   $0x3b
  jmp alltraps
80105e1e:	e9 37 f8 ff ff       	jmp    8010565a <alltraps>
...
80105e25:	6a 3c                	push   $0x3c
  jmp alltraps
80105e27:	e9 2e f8 ff ff       	jmp    8010565a <alltraps>
...
80105e2e:	6a 3d                	push   $0x3d
  jmp alltraps
80105e30:	e9 25 f8 ff ff       	jmp    8010565a <alltraps>
...
80105e37:	6a 3e                	push   $0x3e
  jmp alltraps
80105e39:	e9 1c f8 ff ff       	jmp    8010565a <alltraps>
...
80105e40:	6a 3f                	push   $0x3f
  jmp alltraps
80105e42:	e9 13 f8 ff ff       	jmp    8010565a <alltraps>
...
80105e49:	6a 40                	push   $0x40
  jmp alltraps
80105e4b:	e9 0a f8 ff ff       	jmp    8010565a <alltraps>
...
80105e52:	6a 41                	push   $0x41
  jmp alltraps
80105e54:	e9 01 f8 ff ff       	jmp    8010565a <alltraps>
...
80105e5b:	6a 42                	push   $0x42
  jmp alltraps
80105e5d:	e9 f8 f7 ff ff       	jmp    8010565a <alltraps>
...
80105e64:	6a 43                	push   $0x43
  jmp alltraps
80105e66:	e9 ef f7 ff ff       	jmp    8010565a <alltraps>
...
80105e6d:	6a 44                	push   $0x44
  jmp alltraps
80105e6f:	e9 e6 f7 ff ff       	jmp    8010565a <alltraps>
...
80105e76:	6a 45                	push   $0x45
  jmp alltraps
80105e78:	e9 dd f7 ff ff       	jmp    8010565a <alltraps>
...
80105e7f:	6a 46                	push   $0x46
  jmp alltraps
80105e81:	e9 d4 f7 ff ff       	jmp    8010565a <alltraps>
...
80105e88:	6a 47                	push   $0x47
  jmp alltraps
80105e8a:	e9 cb f7 ff ff       	jmp    8010565a <alltraps>
...
80105e91:	6a 48                	push   $0x48
  jmp alltraps
80105e93:	e9 c2 f7 ff ff       	jmp    8010565a <alltraps>
...
80105e9a:	6a 49                	push   $0x49
  jmp alltraps
80105e9c:	e9 b9 f7 ff ff       	jmp    8010565a <alltraps>
...
80105ea3:	6a 4a                	push   $0x4a
  jmp alltraps
80105ea5:	e9 b0 f7 ff ff       	jmp    8010565a <alltraps>
...
80105eac:	6a 4b                	push   $0x4b
  jmp alltraps
80105eae:	e9 a7 f7 ff ff       	jmp    8010565a <alltraps>
...
80105eb5:	6a 4c                	push   $0x4c
  jmp alltraps
80105eb7:	e9 9e f7 ff ff       	jmp    8010565a <alltraps>
...
80105ebe:	6a 4d                	push   $0x4d
  jmp alltraps
80105ec0:	e9 95 f7 ff ff       	jmp    8010565a <alltraps>
...
80105ec7:	6a 4e                	push   $0x4e
  jmp alltraps
80105ec9:	e9 8c f7 ff ff       	jmp    8010565a <alltraps>
...
80105ed0:	6a 4f                	push   $0x4f
  jmp alltraps
80105ed2:	e9 83 f7 ff ff       	jmp    8010565a <alltraps>
...
80105ed9:	6a 50                	push   $0x50
  jmp alltraps
80105edb:	e9 7a f7 ff ff       	jmp    8010565a <alltraps>
...
80105ee2:	6a 51                	push   $0x51
  jmp alltraps
80105ee4:	e9 71 f7 ff ff       	jmp    8010565a <alltraps>
...
80105eeb:	6a 52                	push   $0x52
  jmp alltraps
80105eed:	e9 68 f7 ff ff       	jmp    8010565a <alltraps>
...
80105ef4:	6a 53                	push   $0x53
  jmp alltraps
80105ef6:	e9 5f f7 ff ff       	jmp    8010565a <alltraps>
...
80105efd:	6a 54                	push   $0x54
  jmp alltraps
80105eff:	e9 56 f7 ff ff       	jmp    8010565a <alltraps>
...
80105f06:	6a 55                	push   $0x55
  jmp alltraps
80105f08:	e9 4d f7 ff ff       	jmp    8010565a <alltraps>
...
80105f0f:	6a 56                	push   $0x56
  jmp alltraps
80105f11:	e9 44 f7 ff ff       	jmp    8010565a <alltraps>
...
80105f18:	6a 57                	push   $0x57
  jmp alltraps
80105f1a:	e9 3b f7 ff ff       	jmp    8010565a <alltraps>
...
80105f21:	6a 58                	push   $0x58
  jmp alltraps
80105f23:	e9 32 f7 ff ff       	jmp    8010565a <alltraps>
...
80105f2a:	6a 59                	push   $0x59
  jmp alltraps
80105f2c:	e9 29 f7 ff ff       	jmp    8010565a <alltraps>
...
80105f33:	6a 5a                	push   $0x5a
  jmp alltraps
80105f35:	e9 20 f7 ff ff       	jmp    8010565a <alltraps>
...
80105f3c:	6a 5b                	push   $0x5b
  jmp alltraps
80105f3e:	e9 17 f7 ff ff       	jmp    8010565a <alltraps>
...
80105f45:	6a 5c                	push   $0x5c
  jmp alltraps
80105f47:	e9 0e f7 ff ff       	jmp    8010565a <alltraps>
...
80105f4e:	6a 5d                	push   $0x5d
  jmp alltraps
80105f50:	e9 05 f7 ff ff       	jmp    8010565a <alltraps>
...
80105f57:	6a 5e                	push   $0x5e
  jmp alltraps
80105f59:	e9 fc f6 ff ff       	jmp    8010565a <alltraps>
...
80105f60:	6a 5f                	push   $0x5f
  jmp alltraps
80105f62:	e9 f3 f6 ff ff       	jmp    8010565a <alltraps>
...
80105f69:	6a 60                	push   $0x60
  jmp alltraps
80105f6b:	e9 ea f6 ff ff       	jmp    8010565a <alltraps>
...
80105f72:	6a 61                	push   $0x61
  jmp alltraps
80105f74:	e9 e1 f6 ff ff       	jmp    8010565a <alltraps>
...
80105f7b:	6a 62                	push   $0x62
  jmp alltraps
80105f7d:	e9 d8 f6 ff ff       	jmp    8010565a <alltraps>
...
80105f84:	6a 63                	push   $0x63
  jmp alltraps
80105f86:	e9 cf f6 ff ff       	jmp    8010565a <alltraps>
...
80105f8d:	6a 64                	push   $0x64
  jmp alltraps
80105f8f:	e9 c6 f6 ff ff       	jmp    8010565a <alltraps>
...
80105f96:	6a 65                	push   $0x65
  jmp alltraps
80105f98:	e9 bd f6 ff ff       	jmp    8010565a <alltraps>
...
80105f9f:	6a 66                	push   $0x66
  jmp alltraps
80105fa1:	e9 b4 f6 ff ff       	jmp    8010565a <alltraps>
...
80105fa8:	6a 67                	push   $0x67
  jmp alltraps
80105faa:	e9 ab f6 ff ff       	jmp    8010565a <alltraps>
...
80105fb1:	6a 68                	push   $0x68
  jmp alltraps
80105fb3:	e9 a2 f6 ff ff       	jmp    8010565a <alltraps>
...
80105fba:	6a 69                	push   $0x69
  jmp alltraps
80105fbc:	e9 99 f6 ff ff       	jmp    8010565a <alltraps>
...
80105fc3:	6a 6a                	push   $0x6a
  jmp alltraps
80105fc5:	e9 90 f6 ff ff       	jmp    8010565a <alltraps>
...
80105fcc:	6a 6b                	push   $0x6b
  jmp alltraps
80105fce:	e9 87 f6 ff ff       	jmp    8010565a <alltraps>
...
80105fd5:	6a 6c                	push   $0x6c
  jmp alltraps
80105fd7:	e9 7e f6 ff ff       	jmp    8010565a <alltraps>
...
80105fde:	6a 6d                	push   $0x6d
  jmp alltraps
80105fe0:	e9 75 f6 ff ff       	jmp    8010565a <alltraps>
...
80105fe7:	6a 6e                	push   $0x6e
  jmp alltraps
80105fe9:	e9 6c f6 ff ff       	jmp    8010565a <alltraps>
...
80105ff0:	6a 6f                	push   $0x6f
  jmp alltraps
80105ff2:	e9 63 f6 ff ff       	jmp    8010565a <alltraps>
...
80105ff9:	6a 70                	push   $0x70
  jmp alltraps
80105ffb:	e9 5a f6 ff ff       	jmp    8010565a <alltraps>
...
80106002:	6a 71                	push   $0x71
  jmp alltraps
80106004:	e9 51 f6 ff ff       	jmp    8010565a <alltraps>
...
8010600b:	6a 72                	push   $0x72
  jmp alltraps
8010600d:	e9 48 f6 ff ff       	jmp    8010565a <alltraps>
...
80106014:	6a 73                	push   $0x73
  jmp alltraps
80106016:	e9 3f f6 ff ff       	jmp    8010565a <alltraps>
...
8010601d:	6a 74                	push   $0x74
  jmp alltraps
8010601f:	e9 36 f6 ff ff       	jmp    8010565a <alltraps>
...
80106026:	6a 75                	push   $0x75
  jmp alltraps
80106028:	e9 2d f6 ff ff       	jmp    8010565a <alltraps>
...
8010602f:	6a 76                	push   $0x76
  jmp alltraps
80106031:	e9 24 f6 ff ff       	jmp    8010565a <alltraps>
...
80106038:	6a 77                	push   $0x77
  jmp alltraps
8010603a:	e9 1b f6 ff ff       	jmp    8010565a <alltraps>
...
80106041:	6a 78                	push   $0x78
  jmp alltraps
80106043:	e9 12 f6 ff ff       	jmp    8010565a <alltraps>
...
8010604a:	6a 79                	push   $0x79
  jmp alltraps
8010604c:	e9 09 f6 ff ff       	jmp    8010565a <alltraps>
...
80106053:	6a 7a                	push   $0x7a
  jmp alltraps
80106055:	e9 00 f6 ff ff       	jmp    8010565a <alltraps>
...
8010605c:	6a 7b                	push   $0x7b
  jmp alltraps
8010605e:	e9 f7 f5 ff ff       	jmp    8010565a <alltraps>
...
80106065:	6a 7c                	push   $0x7c
  jmp alltraps
80106067:	e9 ee f5 ff ff       	jmp    8010565a <alltraps>
...
8010606e:	6a 7d                	push   $0x7d
  jmp alltraps
80106070:	e9 e5 f5 ff ff       	jmp    8010565a <alltraps>
...
80106077:	6a 7e                	push   $0x7e
  jmp alltraps
80106079:	e9 dc f5 ff ff       	jmp    8010565a <alltraps>
...
80106080:	6a 7f                	push   $0x7f
  jmp alltraps
80106082:	e9 d3 f5 ff ff       	jmp    8010565a <alltraps>
...
80106089:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010608e:	e9 c7 f5 ff ff       	jmp    8010565a <alltraps>
...
80106095:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010609a:	e9 bb f5 ff ff       	jmp    8010565a <alltraps>
...
801060a1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801060a6:	e9 af f5 ff ff       	jmp    8010565a <alltraps>
...
801060ad:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801060b2:	e9 a3 f5 ff ff       	jmp    8010565a <alltraps>
...
801060b9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801060be:	e9 97 f5 ff ff       	jmp    8010565a <alltraps>
...
801060c5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801060ca:	e9 8b f5 ff ff       	jmp    8010565a <alltraps>
...
801060d1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801060d6:	e9 7f f5 ff ff       	jmp    8010565a <alltraps>
...
801060dd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801060e2:	e9 73 f5 ff ff       	jmp    8010565a <alltraps>
...
801060e9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801060ee:	e9 67 f5 ff ff       	jmp    8010565a <alltraps>
...
801060f5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801060fa:	e9 5b f5 ff ff       	jmp    8010565a <alltraps>
...
80106101:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106106:	e9 4f f5 ff ff       	jmp    8010565a <alltraps>
...
8010610d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106112:	e9 43 f5 ff ff       	jmp    8010565a <alltraps>
...
80106119:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010611e:	e9 37 f5 ff ff       	jmp    8010565a <alltraps>
...
80106125:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010612a:	e9 2b f5 ff ff       	jmp    8010565a <alltraps>
...
80106131:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106136:	e9 1f f5 ff ff       	jmp    8010565a <alltraps>
...
8010613d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106142:	e9 13 f5 ff ff       	jmp    8010565a <alltraps>
...
80106149:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010614e:	e9 07 f5 ff ff       	jmp    8010565a <alltraps>
...
80106155:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010615a:	e9 fb f4 ff ff       	jmp    8010565a <alltraps>
...
80106161:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106166:	e9 ef f4 ff ff       	jmp    8010565a <alltraps>
...
8010616d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106172:	e9 e3 f4 ff ff       	jmp    8010565a <alltraps>
...
80106179:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010617e:	e9 d7 f4 ff ff       	jmp    8010565a <alltraps>
...
80106185:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010618a:	e9 cb f4 ff ff       	jmp    8010565a <alltraps>
...
80106191:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106196:	e9 bf f4 ff ff       	jmp    8010565a <alltraps>
...
8010619d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801061a2:	e9 b3 f4 ff ff       	jmp    8010565a <alltraps>
...
801061a9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801061ae:	e9 a7 f4 ff ff       	jmp    8010565a <alltraps>
...
801061b5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801061ba:	e9 9b f4 ff ff       	jmp    8010565a <alltraps>
...
801061c1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801061c6:	e9 8f f4 ff ff       	jmp    8010565a <alltraps>
...
801061cd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801061d2:	e9 83 f4 ff ff       	jmp    8010565a <alltraps>
...
801061d9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801061de:	e9 77 f4 ff ff       	jmp    8010565a <alltraps>
...
801061e5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801061ea:	e9 6b f4 ff ff       	jmp    8010565a <alltraps>
...
801061f1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801061f6:	e9 5f f4 ff ff       	jmp    8010565a <alltraps>
...
801061fd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106202:	e9 53 f4 ff ff       	jmp    8010565a <alltraps>
...
80106209:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010620e:	e9 47 f4 ff ff       	jmp    8010565a <alltraps>
...
80106215:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010621a:	e9 3b f4 ff ff       	jmp    8010565a <alltraps>
...
80106221:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106226:	e9 2f f4 ff ff       	jmp    8010565a <alltraps>
...
8010622d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106232:	e9 23 f4 ff ff       	jmp    8010565a <alltraps>
...
80106239:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010623e:	e9 17 f4 ff ff       	jmp    8010565a <alltraps>
...
80106245:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010624a:	e9 0b f4 ff ff       	jmp    8010565a <alltraps>
...
80106251:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106256:	e9 ff f3 ff ff       	jmp    8010565a <alltraps>
...
8010625d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106262:	e9 f3 f3 ff ff       	jmp    8010565a <alltraps>
...
80106269:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010626e:	e9 e7 f3 ff ff       	jmp    8010565a <alltraps>
...
80106275:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010627a:	e9 db f3 ff ff       	jmp    8010565a <alltraps>
...
80106281:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106286:	e9 cf f3 ff ff       	jmp    8010565a <alltraps>
...
8010628d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106292:	e9 c3 f3 ff ff       	jmp    8010565a <alltraps>
...
80106299:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010629e:	e9 b7 f3 ff ff       	jmp    8010565a <alltraps>
...
801062a5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801062aa:	e9 ab f3 ff ff       	jmp    8010565a <alltraps>
...
801062b1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801062b6:	e9 9f f3 ff ff       	jmp    8010565a <alltraps>
...
801062bd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801062c2:	e9 93 f3 ff ff       	jmp    8010565a <alltraps>
...
801062c9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801062ce:	e9 87 f3 ff ff       	jmp    8010565a <alltraps>
...
801062d5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801062da:	e9 7b f3 ff ff       	jmp    8010565a <alltraps>
...
801062e1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801062e6:	e9 6f f3 ff ff       	jmp    8010565a <alltraps>
...
801062ed:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801062f2:	e9 63 f3 ff ff       	jmp    8010565a <alltraps>
...
801062f9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801062fe:	e9 57 f3 ff ff       	jmp    8010565a <alltraps>
...
80106305:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010630a:	e9 4b f3 ff ff       	jmp    8010565a <alltraps>
...
80106311:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106316:	e9 3f f3 ff ff       	jmp    8010565a <alltraps>
...
8010631d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106322:	e9 33 f3 ff ff       	jmp    8010565a <alltraps>
...
80106329:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010632e:	e9 27 f3 ff ff       	jmp    8010565a <alltraps>
...
80106335:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010633a:	e9 1b f3 ff ff       	jmp    8010565a <alltraps>
...
80106341:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106346:	e9 0f f3 ff ff       	jmp    8010565a <alltraps>
...
8010634d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106352:	e9 03 f3 ff ff       	jmp    8010565a <alltraps>
...
80106359:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010635e:	e9 f7 f2 ff ff       	jmp    8010565a <alltraps>
...
80106365:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010636a:	e9 eb f2 ff ff       	jmp    8010565a <alltraps>
...
80106371:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106376:	e9 df f2 ff ff       	jmp    8010565a <alltraps>
...
8010637d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106382:	e9 d3 f2 ff ff       	jmp    8010565a <alltraps>
...
80106389:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010638e:	e9 c7 f2 ff ff       	jmp    8010565a <alltraps>
...
80106395:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010639a:	e9 bb f2 ff ff       	jmp    8010565a <alltraps>
...
801063a1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801063a6:	e9 af f2 ff ff       	jmp    8010565a <alltraps>
...
801063ad:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801063b2:	e9 a3 f2 ff ff       	jmp    8010565a <alltraps>
...
801063b9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801063be:	e9 97 f2 ff ff       	jmp    8010565a <alltraps>
...
801063c5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801063ca:	e9 8b f2 ff ff       	jmp    8010565a <alltraps>
...
801063d1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801063d6:	e9 7f f2 ff ff       	jmp    8010565a <alltraps>
...
801063dd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801063e2:	e9 73 f2 ff ff       	jmp    8010565a <alltraps>
...
801063e9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801063ee:	e9 67 f2 ff ff       	jmp    8010565a <alltraps>
...
801063f5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801063fa:	e9 5b f2 ff ff       	jmp    8010565a <alltraps>
...
80106401:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106406:	e9 4f f2 ff ff       	jmp    8010565a <alltraps>
...
8010640d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106412:	e9 43 f2 ff ff       	jmp    8010565a <alltraps>
...
80106419:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010641e:	e9 37 f2 ff ff       	jmp    8010565a <alltraps>
...
80106425:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010642a:	e9 2b f2 ff ff       	jmp    8010565a <alltraps>
...
80106431:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106436:	e9 1f f2 ff ff       	jmp    8010565a <alltraps>
...
8010643d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106442:	e9 13 f2 ff ff       	jmp    8010565a <alltraps>
...
80106449:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010644e:	e9 07 f2 ff ff       	jmp    8010565a <alltraps>
...
80106455:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010645a:	e9 fb f1 ff ff       	jmp    8010565a <alltraps>
...
80106461:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106466:	e9 ef f1 ff ff       	jmp    8010565a <alltraps>
...
8010646d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106472:	e9 e3 f1 ff ff       	jmp    8010565a <alltraps>
...
80106479:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010647e:	e9 d7 f1 ff ff       	jmp    8010565a <alltraps>
...
80106485:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010648a:	e9 cb f1 ff ff       	jmp    8010565a <alltraps>
...
80106491:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106496:	e9 bf f1 ff ff       	jmp    8010565a <alltraps>
...
8010649d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801064a2:	e9 b3 f1 ff ff       	jmp    8010565a <alltraps>
...
801064a9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801064ae:	e9 a7 f1 ff ff       	jmp    8010565a <alltraps>
...
801064b5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801064ba:	e9 9b f1 ff ff       	jmp    8010565a <alltraps>
...
801064c1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801064c6:	e9 8f f1 ff ff       	jmp    8010565a <alltraps>
...
801064cd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801064d2:	e9 83 f1 ff ff       	jmp    8010565a <alltraps>
...
801064d9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801064de:	e9 77 f1 ff ff       	jmp    8010565a <alltraps>
...
801064e5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801064ea:	e9 6b f1 ff ff       	jmp    8010565a <alltraps>
...
801064f1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801064f6:	e9 5f f1 ff ff       	jmp    8010565a <alltraps>
...
801064fd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106502:	e9 53 f1 ff ff       	jmp    8010565a <alltraps>
...
80106509:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010650e:	e9 47 f1 ff ff       	jmp    8010565a <alltraps>
...
80106515:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010651a:	e9 3b f1 ff ff       	jmp    8010565a <alltraps>
...
80106521:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106526:	e9 2f f1 ff ff       	jmp    8010565a <alltraps>
...
8010652d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106532:	e9 23 f1 ff ff       	jmp    8010565a <alltraps>
...
80106539:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010653e:	e9 17 f1 ff ff       	jmp    8010565a <alltraps>
...
80106545:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010654a:	e9 0b f1 ff ff       	jmp    8010565a <alltraps>
...
80106551:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106556:	e9 ff f0 ff ff       	jmp    8010565a <alltraps>
...
8010655d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106562:	e9 f3 f0 ff ff       	jmp    8010565a <alltraps>
...
80106569:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010656e:	e9 e7 f0 ff ff       	jmp    8010565a <alltraps>
...
80106575:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010657a:	e9 db f0 ff ff       	jmp    8010565a <alltraps>
...
80106581:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106586:	e9 cf f0 ff ff       	jmp    8010565a <alltraps>
...
8010658d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106592:	e9 c3 f0 ff ff       	jmp    8010565a <alltraps>
...
80106599:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010659e:	e9 b7 f0 ff ff       	jmp    8010565a <alltraps>
...
801065a5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801065aa:	e9 ab f0 ff ff       	jmp    8010565a <alltraps>
...
801065b1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801065b6:	e9 9f f0 ff ff       	jmp    8010565a <alltraps>
...
801065bd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801065c2:	e9 93 f0 ff ff       	jmp    8010565a <alltraps>
...
801065c9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801065ce:	e9 87 f0 ff ff       	jmp    8010565a <alltraps>
...
801065d5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801065da:	e9 7b f0 ff ff       	jmp    8010565a <alltraps>
...
801065e1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801065e6:	e9 6f f0 ff ff       	jmp    8010565a <alltraps>
...
801065ed:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801065f2:	e9 63 f0 ff ff       	jmp    8010565a <alltraps>
...
801065f9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801065fe:	e9 57 f0 ff ff       	jmp    8010565a <alltraps>
...
80106605:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010660a:	e9 4b f0 ff ff       	jmp    8010565a <alltraps>
...
80106611:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106616:	e9 3f f0 ff ff       	jmp    8010565a <alltraps>
...
8010661d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106622:	e9 33 f0 ff ff       	jmp    8010565a <alltraps>
...
80106629:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010662e:	e9 27 f0 ff ff       	jmp    8010565a <alltraps>
...
80106635:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010663a:	e9 1b f0 ff ff       	jmp    8010565a <alltraps>
...
80106641:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106646:	e9 0f f0 ff ff       	jmp    8010565a <alltraps>
...
8010664d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106652:	e9 03 f0 ff ff       	jmp    8010565a <alltraps>
...
80106659:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010665e:	e9 f7 ef ff ff       	jmp    8010565a <alltraps>
...
80106665:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010666a:	e9 eb ef ff ff       	jmp    8010565a <alltraps>
...
80106671:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106676:	e9 df ef ff ff       	jmp    8010565a <alltraps>
...
8010667d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106682:	e9 d3 ef ff ff       	jmp    8010565a <alltraps>
...
801066d4:	e8 e7 bd ff ff       	call   801024c0 <kalloc>
...
801066ea:	e8 61 dd ff ff       	call   80104450 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106775:	e8 16 ff ff ff       	call   80106690 <walkpgdir>
    if(!pte)
...
801067a2:	68 26 72 10 80       	push   $0x80107226
...
8010689a:	e8 f1 fd ff ff       	call   80106690 <walkpgdir>
...
801068bd:	68 c0 78 10 80       	push   $0x801078c0
...
80106914:	0f 84 c2 00 00 00    	je     801069dc <switchuvm+0xec>
  pushcli();
8010691a:	e8 51 d9 ff ff       	call   80104270 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010691f:	e8 1c ce ff ff       	call   80103740 <mycpu>
80106924:	89 c6                	mov    %eax,%esi
80106926:	e8 15 ce ff ff       	call   80103740 <mycpu>
...
80106938:	e8 03 ce ff ff       	call   80103740 <mycpu>
...
80106a1a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  mem = kalloc();
80106a1d:	e8 9e ba ff ff       	call   801024c0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106a2f:	e8 1c da ff ff       	call   80104450 <memset>
...
80106a64:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106a65:	e9 96 da ff ff       	jmp    80104500 <memmove>
    panic("inituvm: more than a page");
80106a6a:	83 ec 0c             	sub    $0xc,%esp
80106a6d:	68 05 79 10 80       	push   $0x80107905
...
80106af1:	e8 6a ae ff ff       	call   80101960 <readi>
...
80106b1d:	68 1f 79 10 80       	push   $0x8010791f
...
80106b4e:	0f 88 8f 00 00 00    	js     80106be3 <allocuvm+0xa3>
  if(newsz < oldsz)
...
80106b7b:	eb 43                	jmp    80106bc0 <allocuvm+0x80>
...
80106b8b:	e8 c0 d8 ff ff       	call   80104450 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106b90:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
80106b96:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106b9d:	50                   	push   %eax
80106b9e:	68 00 10 00 00       	push   $0x1000
80106ba3:	53                   	push   %ebx
80106ba4:	56                   	push   %esi
80106ba5:	e8 96 fc ff ff       	call   80106840 <mappages>
80106baa:	83 c4 20             	add    $0x20,%esp
80106bad:	85 c0                	test   %eax,%eax
80106baf:	78 4f                	js     80106c00 <allocuvm+0xc0>
  for(; a < newsz; a += PGSIZE){
80106bb1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106bb7:	39 5d 10             	cmp    %ebx,0x10(%ebp)
80106bba:	0f 86 80 00 00 00    	jbe    80106c40 <allocuvm+0x100>
    mem = kalloc();
80106bc0:	e8 fb b8 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
80106bc5:	85 c0                	test   %eax,%eax
    mem = kalloc();
80106bc7:	89 c7                	mov    %eax,%edi
    if(mem == 0){
80106bc9:	75 b5                	jne    80106b80 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80106bcb:	83 ec 0c             	sub    $0xc,%esp
80106bce:	68 67 77 10 80       	push   $0x80107767
80106bd3:	e8 88 9a ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106bd8:	83 c4 10             	add    $0x10,%esp
80106bdb:	8b 45 0c             	mov    0xc(%ebp),%eax
80106bde:	39 45 10             	cmp    %eax,0x10(%ebp)
80106be1:	77 6d                	ja     80106c50 <allocuvm+0x110>
}
80106be3:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80106be6:	31 ff                	xor    %edi,%edi
}
80106be8:	89 f8                	mov    %edi,%eax
80106bea:	5b                   	pop    %ebx
80106beb:	5e                   	pop    %esi
80106bec:	5f                   	pop    %edi
80106bed:	5d                   	pop    %ebp
...
80106c03:	89 fe                	mov    %edi,%esi
80106c05:	68 7f 77 10 80       	push   $0x8010777f
80106c0a:	e8 51 9a ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106c0f:	83 c4 10             	add    $0x10,%esp
80106c12:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c15:	39 45 10             	cmp    %eax,0x10(%ebp)
80106c18:	76 0d                	jbe    80106c27 <allocuvm+0xe7>
80106c1a:	89 c1                	mov    %eax,%ecx
80106c1c:	8b 55 10             	mov    0x10(%ebp),%edx
80106c1f:	8b 45 08             	mov    0x8(%ebp),%eax
80106c22:	e8 e9 fa ff ff       	call   80106710 <deallocuvm.part.0>
      kfree(mem);
80106c27:	83 ec 0c             	sub    $0xc,%esp
      return 0;
80106c2a:	31 ff                	xor    %edi,%edi
      kfree(mem);
80106c2c:	56                   	push   %esi
80106c2d:	e8 de b6 ff ff       	call   80102310 <kfree>
      return 0;
...
80106c58:	e8 b3 fa ff ff       	call   80106710 <deallocuvm.part.0>
80106c5d:	eb 94                	jmp    80106bf3 <allocuvm+0xb3>
80106c5f:	90                   	nop
...
80106c70:	5d                   	pop    %ebp
80106c71:	e9 9a fa ff ff       	jmp    80106710 <deallocuvm.part.0>
...
80106ca9:	e8 62 fa ff ff       	call   80106710 <deallocuvm.part.0>
...
80106cfc:	68 3d 79 10 80       	push   $0x8010793d
...
80106d30:	e8 1b d7 ff ff       	call   80104450 <memset>
...
80106d4b:	e8 f0 fa ff ff       	call   80106840 <mappages>
...
80106d9b:	a3 a4 54 11 80       	mov    %eax,0x801154a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106dbe:	e8 cd f8 ff ff       	call   80106690 <walkpgdir>
  if(pte == 0)
...
80106dcf:	68 4e 79 10 80       	push   $0x8010794e
...
80106df3:	0f 84 a2 00 00 00    	je     80106e9b <copyuvm+0xbb>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106df9:	8b 55 0c             	mov    0xc(%ebp),%edx
80106dfc:	85 d2                	test   %edx,%edx
80106dfe:	0f 84 97 00 00 00    	je     80106e9b <copyuvm+0xbb>
...
80106e20:	e8 db d6 ff ff       	call   80104500 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106e25:	58                   	pop    %eax
80106e26:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
80106e2c:	ff 75 e4             	pushl  -0x1c(%ebp)
80106e2f:	50                   	push   %eax
80106e30:	68 00 10 00 00       	push   $0x1000
80106e35:	56                   	push   %esi
80106e36:	ff 75 e0             	pushl  -0x20(%ebp)
80106e39:	e8 02 fa ff ff       	call   80106840 <mappages>
80106e3e:	83 c4 20             	add    $0x20,%esp
80106e41:	85 c0                	test   %eax,%eax
80106e43:	78 6b                	js     80106eb0 <copyuvm+0xd0>
  for(i = 0; i < sz; i += PGSIZE){
80106e45:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106e4b:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106e4e:	76 4b                	jbe    80106e9b <copyuvm+0xbb>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106e50:	8b 45 08             	mov    0x8(%ebp),%eax
80106e53:	31 c9                	xor    %ecx,%ecx
80106e55:	89 f2                	mov    %esi,%edx
80106e57:	e8 34 f8 ff ff       	call   80106690 <walkpgdir>
80106e5c:	85 c0                	test   %eax,%eax
80106e5e:	74 6b                	je     80106ecb <copyuvm+0xeb>
    if(!(*pte & PTE_P))
80106e60:	8b 38                	mov    (%eax),%edi
80106e62:	f7 c7 01 00 00 00    	test   $0x1,%edi
80106e68:	74 54                	je     80106ebe <copyuvm+0xde>
    pa = PTE_ADDR(*pte);
80106e6a:	89 fb                	mov    %edi,%ebx
    flags = PTE_FLAGS(*pte);
80106e6c:	81 e7 ff 0f 00 00    	and    $0xfff,%edi
80106e72:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106e75:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    if((mem = kalloc()) == 0)
80106e7b:	e8 40 b6 ff ff       	call   801024c0 <kalloc>
80106e80:	85 c0                	test   %eax,%eax
80106e82:	89 c7                	mov    %eax,%edi
80106e84:	75 8a                	jne    80106e10 <copyuvm+0x30>
    }
  }
  return d;
...
80106e89:	ff 75 e0             	pushl  -0x20(%ebp)
80106e8c:	e8 ff fd ff ff       	call   80106c90 <freevm>
  return 0;
80106e91:	83 c4 10             	add    $0x10,%esp
80106e94:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
...
80106ebc:	eb c8                	jmp    80106e86 <copyuvm+0xa6>
      panic("copyuvm: page not present");
80106ebe:	83 ec 0c             	sub    $0xc,%esp
80106ec1:	68 72 79 10 80       	push   $0x80107972
80106ec6:	e8 c5 94 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106ecb:	83 ec 0c             	sub    $0xc,%esp
80106ece:	68 58 79 10 80       	push   $0x80107958
80106ed3:	e8 b8 94 ff ff       	call   80100390 <panic>
80106ed8:	90                   	nop
...
80106f5f:	e8 9c d5 ff ff       	call   80104500 <memmove>
    len -= n;
    buf += n;
