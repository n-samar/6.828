	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800256:	0f be 84 06 7d ee ff 	movsbl -0x1183(%esi,%eax,1),%eax
  80025d:	ff 
  80025e:	50                   	push   %eax
...
008002ab <vprintfmt>:
{
  ...
  800304:	03 8c 83 0c ef ff ff 	add    -0x10f4(%ebx,%eax,4),%ecx
...
008003bc <.L32>:
  ...
  8003d9:	52                   	push   %edx
  8003da:	8d 83 9e ee ff ff    	lea    -0x1162(%ebx),%eax
  8003e0:	50                   	push   %eax
  8003e1:	56                   	push   %esi
  ...
  8003f5:	50                   	push   %eax
  8003f6:	8d 83 95 ee ff ff    	lea    -0x116b(%ebx),%eax
  8003fc:	50                   	push   %eax
  8003fd:	56                   	push   %esi
...
00800411 <.L36>:
  ...
  800421:	8d 83 8e ee ff ff    	lea    -0x1172(%ebx),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b77:	8d 83 64 f0 ff ff    	lea    -0xf9c(%ebx),%eax
  800b7d:	50                   	push   %eax
  800b7e:	6a 23                	push   $0x23
  800b80:	8d 83 81 f0 ff ff    	lea    -0xf7f(%ebx),%eax
  800b86:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800bdc:	57                   	push   %edi
  800bdd:	50                   	push   %eax
  800bde:	8d 83 90 f0 ff ff    	lea    -0xf70(%ebx),%eax
  800be4:	50                   	push   %eax
  ...
  800bf1:	e8 3b f5 ff ff       	call   800131 <vcprintf>
	cprintf("\n");
  800bf6:	8d 83 b4 f0 ff ff    	lea    -0xf4c(%ebx),%eax
